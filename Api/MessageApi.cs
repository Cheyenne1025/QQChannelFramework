...
public class MessageApi {
    ...
    public async Task<Message> SendEmbedMessageAsync(string channelId, JObject embedTemplate,
        ...
        var requestData =
            await _apiBase.WithJsonContentData(embedMessage).RequestAsync(processedInfo).ConfigureAwait(false);
    ...
    public async Task<Message> SendImageMessageAsync(string channelId, string imageUrl, string passiveReference = "") {
        ...
        var requestData =
            await _apiBase.WithJsonContentData(imageMessage).RequestAsync(processedInfo).ConfigureAwait(false);
    ...
    public async Task<Message> SendImageAndTextMessageAsync(string channelId, string imageUrl, string content,
        ...
        var requestData =
            await _apiBase.WithJsonContentData(imageAndTextMessage).RequestAsync(processedInfo).ConfigureAwait(false);
